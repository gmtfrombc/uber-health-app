              ...
              return Dismissible(
                ...
                confirmDismiss: (direction) async {
                  ...
                  try {
                    ...
                    if (!wasStillMounted) return false;
                ...
                onDismissed: (direction) async {
                  ...
                  try {
                    ...
                    WidgetsBinding.instance.addPostFrameCallback((_) async {
                      // Check mounted again before another async operation
                      if (!mounted) return;
                          ...
                          onPressed: () async {
                            ...
                            try {
                              ...
                              if (shouldDelete) {
                                ...
                                // Check mounted state again after second async operation
                                if (!mounted) return;
                              ...
                              // Only try to use context if widget is still mounted
                              if (mounted) {
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  // Store the mounted state in a local variable before async operation
                  final wasStillMounted = mounted;
                  await _submitProviderResponse(dashboardProvider, response);

                  // Only show UI if still mounted
                  if (!wasStillMounted) return;
                },
                child: Text('Submit'),
              ),
